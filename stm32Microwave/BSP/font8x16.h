/* font8x16.h — header-only 8x16 font table
   Exactly ONE .c file should #define FONT8x16_IMPLEMENTATION before including this header.
   All other files should include it normally (no macro) to get the extern declaration.
*/
#ifndef FONT8x16_H
#define FONT8x16_H
...
/* Declaration (no storage). IMPORTANT: use extern so other units don't define it */
extern const uint8_t font8x16[][16];
#else
/* Definition (with storage) in exactly one .c file */
