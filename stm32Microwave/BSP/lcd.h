...
/* ========= Panel geometry =========
 * Logical width/height before rotation. The driver will swap them
 * internally when you call LCD_SetRotation(0..3).
 */
...
/* Optional helpers (implemented in lcd.c; comment out if unused) */
 ...
 * you can use these convenience functions (implemented in lcd.c).
 * If BL is hard-wired to 3V3, these are no-ops.
 */
